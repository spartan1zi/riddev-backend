...
/// List of disputes linked to this customer (raised by them or on their jobs).
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'When a dispute is opened on a job with funds in escrow, it will appear here. You can chat with support and resolve issues in one place.',
                                    textAlign: TextAlign.center,
                                ...
                                return Material(
                                  ...
                                  child: InkWell(
                                    onTap: id.isEmpty
                                        ? null
                                        : () async {
                                            await context.push('/dispute-thread/$id');
...
/// Shared thread with admin + other party (customer messaging in their app).
...
class _DisputeThreadScreenState extends ConsumerState<DisputeThreadScreen> {
  ...
  /// Clears in-app unread badges for this dispute (backend `dispute_message` notifications).
  ...
  /// Input row visible only on Support tab (unless locked) or on Everyone when admin opened it.
  ...
  String get _sendChannel =>
      _tab == _DisputeChannelTab.everyone ? 'ALL' : 'ADMIN_CUSTOMER';
